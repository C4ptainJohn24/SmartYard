...
export default function Hortela() {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Image source={require('../../assets/Hortela.png')} style={styles.vegetableImage} />
            <Text style={styles.vegetableName}>Minha horta de Hortelã</Text>
