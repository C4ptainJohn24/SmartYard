            ...
            case 1:
                return (
                    <View>
                        ...
                        <Text style={{ textAlign: 'center', marginBottom: 50, marginTop:'5%', color: 'black', fontFamily:'Quicksand_500Medium'}}>
                            Deslize para ver diferentes opções e selecione o legume desejado.
                        </Text>
                        <Image
                            source={require('../assets/Oque.gif')}
                            style={{ width: 200, height: 200, left: 50, resizeMode: 'contain', alignSelf: 'center' }}
                        />
                    </View>
...
const SelecaoLegumeScreen = ({ navigation }) => {
    ...
    const ConteudoPress = () => {
        ...
        alert('Função desabilitada para apresentação! Observe através da Horta pré-adicionada!')
    };
        ...
        >
            ...
            {selectedLegume && (
                <Animated.View style={[styles.buttonContainer, { transform: [{ translateY }] }]}>
                    <TouchableOpacity style={styles.button} onPress={ConteudoPress}>
                        <AntDesign name="arrowright" size={24} color="white" />
                    </TouchableOpacity>
                </Animated.View>
            )}
